...
import zerobase.hhs.reservation.dto.request.reserve.ReserveListRequest;
...
public class PartnerReservationController {
    ...
    @GetMapping("/list")
    public ResponseEntity<ReserveListResponse> getReservationList(ReserveListRequest request){
